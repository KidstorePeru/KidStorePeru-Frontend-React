...
const Sidebar = ({ admin }: { admin: boolean }) => {
  ...
  return (
    ...
    >
      {/* Logo + toggle */}
      <div style={{ padding:"16px 12px", borderBottom:"1px solid var(--border)", display:"flex",
        ...
        <div style={{
          ...
          <img src={imagotipo} alt="KidStore"
            style={{
        ...
        <motion.button whileHover={{ scale:1.08 }} whileTap={{ scale:0.92 }}
          ...
          style={{ padding:"7px", borderRadius:"9px", background:"var(--bg-card)",
      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} exit={{ opacity:0 }}
            style={{ padding:"14px 18px 4px", fontSize:"10px", fontWeight:700,
                ...
                <AnimatePresence>
                  {isSidebarOpen && (
                    <motion.span initial={{ opacity:0, width:0 }} animate={{ opacity:1, width:"auto" }}
                      exit={{ opacity:0, width:0 }} transition={{ duration:0.18, delay:0.04 }}
            ...
            <AnimatePresence>
              {isSidebarOpen && (
                <motion.span initial={{ opacity:0, width:0 }} animate={{ opacity:1, width:"auto" }}
                  ...
                  style={{ fontSize:"13px", fontWeight:600, color:"var(--danger)",
                    whiteSpace:"nowrap", overflow:"hidden", fontFamily:"'Manrope',sans-serif" }}>
                  Cerrar Sesión
                </motion.span>
              )}
