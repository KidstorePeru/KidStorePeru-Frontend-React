...
const AdminOrdersPage: React.FC = () => {
  ...
  const stats = [
    ...
    { icon: <Users size={18} color="#34d399" />, label: "Receptores únicos", value: uniqueReceivers.toLocaleString(), bg: "rgba(52,211,153,0.1)", border: "rgba(52,211,153,0.2)" },
    { icon: <Gamepad2 size={18} color="#fbbf24" />, label: "Cuentas origen", value: uniqueSenders.toLocaleString(), bg: "rgba(251,191,36,0.1)", border: "rgba(251,191,36,0.2)" },
  ];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "12px", color: "var(--text-muted)", margin: 0 }}>
              Administrador · Todas las transacciones
            </p>
          </div>
        </div>
